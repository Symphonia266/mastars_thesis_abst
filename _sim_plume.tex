...
\cref{fig:situation_plume}に, シミュレーションに用いる火山ガス濃度の水平面分布, 
\cref{fig:res_plume_meas_widespread}, 
\cref{fig:res_plume_meas_narrowspread}にそれぞれの濃度分布における
ラマンDIAL測定シミュレーション結果を示す. 
...
距離分解能が十分な測定点では５章で示した信号加算を用いることで
